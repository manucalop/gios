...
/** Matrix of size: 21 x 207 (row major format)
 * 
...
/** Row vector of size: 222 */
real_t objValueIn[ 222 ];
...
/** Matrix of size: 140 x 15 (row major format) */
real_t R2[ 2100 ];
