...
#define ACADO_NOD 211
/** Number of path constraints. */
#define ACADO_NPAC 32
...
/** Matrix of size: 21 x 211 (row major format)
 * 
...
/** Matrix of size: 4 x 128 (row major format) */
real_t rk_kkk[ 512 ];
...
/** Row vector of size: 226 */
real_t objValueIn[ 226 ];

/** Row vector of size: 19 */
real_t objValueOut[ 19 ];

/** Matrix of size: 160 x 8 (row major format) */
real_t Q1[ 1280 ];

/** Matrix of size: 160 x 19 (row major format) */
real_t Q2[ 3040 ];

/** Matrix of size: 140 x 7 (row major format) */
real_t R1[ 980 ];

/** Matrix of size: 140 x 19 (row major format) */
real_t R2[ 2660 ];
...
/** Column vector of size: 754 */
real_t conAuxVar[ 754 ];

/** Row vector of size: 226 */
real_t conValueIn[ 226 ];

/** Row vector of size: 512 */
real_t conValueOut[ 512 ];

/** Column vector of size: 640 */
real_t evH[ 640 ];

/** Matrix of size: 640 x 8 (row major format) */
real_t evHx[ 5120 ];

/** Matrix of size: 640 x 7 (row major format) */
real_t evHu[ 4480 ];
...
/** Matrix of size: 1680 x 7 (row major format) */
real_t E[ 11760 ];
...
/** Matrix of size: 140 x 8 (row major format) */
real_t H10[ 1120 ];
...
/** Column vector of size: 640 */
real_t pacA01Dx0[ 640 ];

/** Matrix of size: 140 x 140 (row major format) */
real_t H[ 19600 ];

/** Matrix of size: 640 x 140 (row major format) */
real_t A[ 89600 ];
